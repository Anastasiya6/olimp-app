                    ...
                    <form method="POST" action="{{ route('designations.store') }}">
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="designation" class="block w-full mt-1 rounded-md" placeholder=""
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="route" class="block w-full mt-1 rounded-md" placeholder=""
                                       value="{{ old('route') }}" />
                            </label>
                            @error('route')
                            <div class="text-sm text-red-600">{{ $message }}</div>
