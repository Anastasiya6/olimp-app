                    ...
                    <form method="POST" action="{{ route($route.'.store') }}">
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text"  name="designation_designation" class="block w-full mt-1 rounded-md" placeholder=""
                                       value="{{ $lastDesignation->designation}}" />
                            </label>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="specification_quantity" class="block w-full mt-1 rounded-md" placeholder=""
                                       value="{{ old('specification_quantity') }}" />
                            </label>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="specification_category_code" class="block w-full mt-1 rounded-md" placeholder=""
                                       value="{{ old('specification_category_code') }}" />
                            </label>
