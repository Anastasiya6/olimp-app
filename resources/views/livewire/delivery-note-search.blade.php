<div>
    ...
    <div class="gap-4 sm:flex py-6">
        ...
        <a href="{{ route('delivery.notes', ['sender_department' => $selectedDepartmentSender, 'receiver_department' => $selectedDepartmentReceiver,'order_name_id' => $selectedOrder]) }}" class="underline-link" target="_blank">
            Pdf
        </a>
