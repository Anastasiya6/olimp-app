...
Route::get('delivery-note/{sender_department}/{receiver_department}/{order_name_id}/{document_number}', [DeliveryNoteDocumentController::class,'deliveryNote'])->name('delivery.notes');
